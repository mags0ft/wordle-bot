...
2. put the wordlist in the `wordlists` folder, make sure it's a `.json` list (you can find [basic conversion scripts](./wordlists/utils/README.md) in the `wordlists/utils` folder)
